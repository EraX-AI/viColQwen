...
1.  **Heterogeneous Data Integration:** The model is trained on a carefully curated mixture of four distinct data types, forcing it to learn diverse aspects of vision-language correlation:
    *   **Text-Text Semantic Similarity:** Pairs of texts with continuous similarity scores (0.0 to 1.0), combining very hard-negative & very hard-positive samples, multi-lingual to teaching nuanced semantic understanding. (5.6M samples)
...
* Will announce upon release. There will be commercial version as well. Contact us for information at nguyen@hatto.com.
